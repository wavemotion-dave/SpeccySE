...
extern void speccy_decompress_snapshot(int romSize);
extern void speccy_restore_z80(void);
extern void speccy_restore_sna(void);
extern void zx_bank(u8 new_bank);
